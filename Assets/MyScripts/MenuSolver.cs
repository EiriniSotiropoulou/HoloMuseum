...
{ 
    ...
    public override void SolverUpdate()
    {
        ...
        if (CoreServices.InputSystem.GazeProvider.GazeTarget == gameObject) // || CoreServices.InputSystem.GazeProvider.GazeTarget == gameObject.transform.GetChild(0).transform.GetChild(1)
        {
